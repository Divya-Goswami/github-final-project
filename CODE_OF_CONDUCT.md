...
1. **Correction**  
   *Community Impact*: A single inappropriate comment or behavior.  
   *Consequence*: A private, written warning from community leaders, explaining the violation and why the behavior was inappropriate.  

2. **Warning**  
   *Community Impact*: A pattern of inappropriate behavior.  
...
3. **Temporary Ban**  
   ...
   *Consequence*: A temporary ban from the community for a specified period.  

4. **Permanent Ban**  
   *Community Impact*: A clear pattern of violating the Code of Conduct or severe harassment.  
